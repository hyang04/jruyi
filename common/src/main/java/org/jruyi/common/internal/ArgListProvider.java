...
public final class ArgListProvider implements IFactory {
	...
	private static final ArgListProvider m_inst = new ArgListProvider();

	static final class ArgList implements IArgList {

		private static final IThreadLocalCache<ArgList> m_cache = ThreadLocalCache.weakLinkedCache();
	...
	@Override
	public IArgList create(Object arg0,
			Object arg1, Object arg2, Object arg3, Object arg4, Object arg5) {
		ArgList argList = ArgList.get();
