...
public interface IFilter {
	 ...
	 * <p>
	 * If this method returns true and the output is not null, then the
	 * output will be passed to the next filter's {@code onMsgArrive} as
	 * {@code msg}.
	 * <p>
	 * If this method returns true and the output is null, then the
	 * following filters will be skipped.
	 * <p>
	 * If this method returns false and no output is returned, then the
	 ...
	 * filter routine stops here and the output will go backward doing
	 * outbound filtering.
	 * 
	 * @param session
	 *            the current IO session
	 ...
	 * <p>
	 * If this method returns true and the output is not null, then the
	 * output will be passed to the previous filter's {@code onMsgDepart}
	 * as {@code msg}.
	 * <p>
	 * If this method returns true and the output is null, then the
	 * following filters will be skipped.
